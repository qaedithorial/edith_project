...
//    }
    ...
    public String mostPopolarDestination(){
        ...
        for(int i = 0; i <_noOfFlights - 1; i++){
            ...
            for(int j = i + 1; j<_noOfFlights; j++){
    ...
    public Flight mostExpensiveTicket(){
        ...
        return new Flight(expensiveTicket);
    }
